<?php    
   ...
   switch($url) {
        ...
        case "/code/cipa_t1/eleicao/bloquear-candidatos":
            require_once __DIR__ . "/controllers/EleicaoGerenciarController.php";
            $eleicaoGerenciarController = new EleicaoGerenciarController();
            $eleicaoGerenciarController->bloquearCandidatos($requisicao);
            break;

        case "/code/cipa_t1/eleicao/permitir-candidatos":
            require_once __DIR__ . "/controllers/EleicaoGerenciarController.php";
            $eleicaoGerenciarController = new EleicaoGerenciarController();
            $eleicaoGerenciarController->permitirCandidatos($requisicao);
            break;
