   ...
   switch($url) {
        ...
        case "/code/cipa_t1/funcionario/home":
            ...
            $is_mobile = (isset($_SERVER['HTTP_USER_AGENT']) && 
                        (preg_match('/Mobile|Android|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini|IEMobile/', $_SERVER['HTTP_USER_AGENT'])) ||
                        (isset($_SERVER['HTTP_ACCEPT']) && 
                         strpos(strtolower($_SERVER['HTTP_ACCEPT']), 'mobile') !== false));
            
            // Redirecionar para versão mobile se for dispositivo móvel
            if ($is_mobile) {
                include "./views/funcionario/home_mobile.php";
            } else {
