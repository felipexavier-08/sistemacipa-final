    ...
    <div class="container">
        ...
        <div class="form-container">
            ...
            <form method="post" action="/code/cipa_t1/funcionario/editar">
                ...
                <input type="date" id="dataNascimentoFuncionario" name="dataNascimentoFuncionario" value="<?php echo $funcionario->getDataNascimentoFuncionario(); ?>" required onchange="preencherSenhaPadrao()">
                ...
                <input type="text" id="senhaFuncionario" name="senhaFuncionario" value="<?php echo htmlspecialchars($funcionario->getSenhaFuncionario()); ?>" readonly style="background-color: #f5f5f5; cursor: not-allowed;">
                <small><em>A senha é definida automaticamente como a data de nascimento (DDMMAAAA)</em></small>
