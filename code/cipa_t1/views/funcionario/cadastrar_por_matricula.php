...
<body>
    ...
    <div class="container">
        <div class="form-container">
            <h1>Buscar por Matrícula e CPF</h1>
            ...
            <form method="post" action="/code/cipa_t1/funcionario/cadastrar-por-matricula">
                ...
                <input type="text" id="matriculaFuncionario" name="matriculaFuncionario" required placeholder="Digite a matrícula do funcionário">
