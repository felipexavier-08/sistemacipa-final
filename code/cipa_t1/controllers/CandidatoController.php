    ...
    class CandidatoController {
        ...
        public function autocandidatura($requisicao) {
            ...
            if ($requisicao === "POST") {
                ...
                $candidatoExistente = $this->candidatoDAO->buscarPorFuncionarioEEleicao($idFuncionarioLogado, $idEleicao);
                ...
                $numeroExistente = $this->candidatoDAO->buscarPorNumeroEEleicao($_POST['numeroCandidato'], $idEleicao);
                if ($numeroExistente) {
                ...
                $resposta = $this->candidatoDAO->inserir($candidato, $idFuncionarioLogado, $idEleicao);
