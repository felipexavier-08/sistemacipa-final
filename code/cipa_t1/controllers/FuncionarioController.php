    ...
    class FuncionarioController {
        ...
        public function criarFuncionario($requisicao) {
            if($requisicao == "POST"){
                ...
                if($respostaBD) {
                    // Enviar código de voto por email usando EmailService
                    error_log("DEBUG: Tentando enviar email para: " . $_POST['emailFuncionario'] . " - Código: " . $_POST['codigoVotoFuncionario']);
                    
                    $emailService = new EmailService();
                    $emailEnviado = $emailService->enviarCodigoVoto($_POST['emailFuncionario'], $_POST['codigoVotoFuncionario'], $_POST['nomeFuncionario']);
                    ...
                    if ($emailEnviado) {
                        ...
                        // Email falhou - mostrar código na tela e link para diagnóstico
                        AlertHelper::erroFuncionario("Funcionário cadastrado com sucesso, mas houve erro ao enviar o email. Código de voto: " . $_POST['codigoVotoFuncionario'] . " - <a href='/code/cipa_t1/diagnosticar_email.php' style='color: white; text-decoration: underline;'>Clique aqui para diagnosticar o email</a>");
                    }
